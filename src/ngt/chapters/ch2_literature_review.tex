...
\hs To overcome the fragility of handcrafted features, researchers have transitioned to deep-learning algorithms that autonomously learn hierarchical representations from raw image data \cite{zhang-2024a}. This section reviews the development of deep neural networks for pixel-level and instance-level crack segmentation.

\subsection{Semantic Segmentation}

Semantic segmentation treats crack extraction as a dense, pixel-level binary classification task, assigning a label of ``1'' to crack pixels and ``0'' to the background. This approach permits precise, pixel-wise delineation of irregular and tortuous crack shapes \cite{liu-2019}. The most foundational architectures deployed for this task include:
\begin{itemize}
